...
if __name__ == "__main__":
    ...
    for e_mean in e_mean_list:
        for rho_gamma in rho_gamma_list:
            ...
            res_folder = f"{res_folder_all}/rhogamma={rho_gamma:.2f}_emean={e_mean:.1f}"
            try:
                os.mkdir(res_folder)
            ...
            print("*****************************************************************************")
            print(f"***Starting simulations for rho_gamma={rho_gamma}, e_mean={e_mean}***",
                  flush=True)
            print("*****************************************************************************")
